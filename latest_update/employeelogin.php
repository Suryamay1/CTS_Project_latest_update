...
if(isset($_POST['submit']))
{
    ...
    $password = $_POST['pass'];  
        ...
        $sql = "select * from userlogin where username = '$username' and password = '$password' and type='employee'";  
...
<body>
  <div class = "container">
		<form action="employeelogin.php" method="post" name="Login_Form" class="form">
